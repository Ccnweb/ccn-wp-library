...
test_tags_to_wrap_content();

function test_tags_to_wrap_content() {
    $res = lib\tags_to_wrap_content("the content", ['wrap-div.riri']);
    expect($res, '<div class="riri">the content</div>');
}
